...
theta = [45:1:85] * degrees;             % elevation angle
NN = length(theta);
...
erd = [nSiw(lam0/nanometers)^2 nSiO2w(lam0/nanometers)^2];

d = 100 * nanometers;

Lx = 100 * nanometers; %period along x
Ly = 100 * nanometers; %period along y
