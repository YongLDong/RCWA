...
%     S.s11    = SA.s11 + SA.s12*(pinv(I-SB.s11*SA.s22)*(SB.s11*SA.s21));
%     S.s12    = SA.s12*(pinv(I-SB.s11*SA.s22)*SB.s12);
%     S.s21    = SB.s21*(pinv(I-SA.s22*SB.s11)*SA.s21);
%     S.s22    = SB.s22 + SB.s21*(pinv(I-SA.s22*SB.s11)*(SA.s22*SB.s12));
end